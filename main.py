...
# It will receive updates via Flask webhook.
pyro_client = Client(
    "image_linker_bot",
    api_id=API_ID,
    api_hash=API_HASH,
...
async def set_webhook_on_startup():
    ...
    if not webhook_base_url:
        ...
        print("You must manually set the webhook if deploying elsewhere or if env var is missing.")
        return
    ...
    try:
        # Start Pyrogram client to set webhook
